...
$measurement = $this->options->get_option('measurement', 'form-settings') ?? 'cm';
...
<form class="woo-product-dimensions" id="_woo-product-dimensions_form">
    ...
    <div class="woo-product-dimensions-form">
        <div class="woo-product-dimensions-form_col">
            <label for="_woo_product_dimensions_x"><?php echo $measurement_label_x; ?> (<?php echo $measurement; ?>)</label>
            <input type="number" id="_woo_product_dimensions_x" name="_woo_product_dimensions_x" />
        </div>
        <div class="woo-product-dimensions-form_col">
            <label for="_woo_product_dimensions_y"><?php echo $measurement_label_y; ?> (<?php echo $measurement; ?>)</label>
